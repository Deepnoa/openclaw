...
export const fr: TranslationMap = {
  ...
  knowledge: {
    ...
    related: "Related",
    noRetrievalResults: "No results returned.",
    decision: "Decision",
    decisionReason: "Reason",
    sensitivity: "Sensitivity",
    retrievalAllowed: "Retrieval",
    exportAllowed: "Exporter",
    ragSafe: "RAG-safe",
    id: "ID",
    artifactType: "Artifact type",
    createdAt: "Created",
    detailTitle: "Manifest Detail",
    detailClose: "Close",
    detailLoading: "Loading detail…",
    detailNoData: "No detail available.",
    detailGovernance: "Governance",
    detailCapabilities: "Capabilities",
    detailRetrievalHistory: "Retrieval History",
    detailNoHistory: "No recent retrieval activity.",
    detailRuntimeRefs: "Runtime References",
    detailNoRuntimeRefs: "No runtime references yet.",
    detailSystem: "Système",
    detailUsage: "Utilisation",
    usageRetrievalCount: "Retrievals",
    usageFirstRetrieved: "First retrieved",
    usageLastRetrieved: "Last retrieved",
    graphTitle: "Reference Graph",
    graphNodes: "nodes",
    graphEdges: "edges",
    graphLoading: "Loading graph…",
    graphNoEdges: "No references found.",
    graphSource: "Source",
    graphRelation: "Relation",
    graphTarget: "Target",
    graphTimestamp: "Timestamp",
    graphAllNodeTypes: "All node types",
    graphAllRelations: "All relations",
    usageTitle: "Utilisation",
    usageLoading: "Loading usage…",
    usageTotalRetrievals: "retrievals",
    usageTotalDiscoveries: "discoveries",
    usageBlockedAttempts: "blocked",
    usageStaleReferences: "stale refs",
    usageTopManifests: "Top referenced",
    usageUnusedManifests: "Unused manifests",
  },
  cron: {
    quickCreate: {
      schedules: {
